...
inline bool GEO::equal(double a, double b) 
{
	return (abs(a - b) < EPSILON);
}

inline double GEO::determinant2x2(double a, double b, double c, double d)
{
	return (a * c - b * d);
}

inline double GEO::determinant3x3(double a, double b, double c, double d, double e, double f, double g, double h, double i)
{
	return (a * e * i + g * b * f + c * d * h - c * e * g - i * d * b - a * h * f);
}

inline double GEO::min3(double a, double b, double c)
{
	return (a < b ? (a < c ? a : c) : (b < c ? b : c));
}

inline double GEO::max3(double a, double b, double c)
{
	return (a > b ? (a > c ? a : c) : (b > c ? b : c));
}

inline double GEO::min2(double a, double b)
{
	return (a < b ? a : b);
}

inline double GEO::max2(double a, double b)
{
	return (a > b ? a : b);
}